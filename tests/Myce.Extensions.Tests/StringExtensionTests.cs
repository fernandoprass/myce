...
namespace Myce.Extensions.Tests
{
   ...
   public class StringExtensionTests
   {
      ...
      [InlineData(" 1á2-3ñ4 Z5?", " 1á23ñ4 Z5")]
      [InlineData("abc", "abc")]
      [InlineData("", "")]
      [InlineData(null, null)]
      ...
      [InlineData("á1é2í3óú", "a1e2i3ou")]
      [InlineData("áéíóú ÁÉÍÓÚ ãÃõÕ çÇ.ñÑ", "aeiou AEIOU aAoO cC.nN")]
      ...
      [Fact]
      public void ToEnum_ReceiveValidEnum_ReturnsTheEnumItem()
      {
         string season = "Summer";

         var result = season.ToEnum<Season>();
