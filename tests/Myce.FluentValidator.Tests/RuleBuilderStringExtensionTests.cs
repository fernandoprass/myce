...
namespace Myce.FluentValidator.Tests
{
   public class RuleBuilderStringExtensionTests
   {
      ...
      public void ContainsOnlyNumber_WithDefaultMessage()
      {
         ...
         Assert.Equal(StringErrorMessages.ShouldContainOnlyNumberError, validator.Messages.First().Code);
      }
      ...
      public void MaxLength_and_MaxLengthIf_WithDefaultMessage()
      {
         ...
         Assert.Equal(StringErrorMessages.MoreCharactersThanExpectedError, validator1.Messages.First().Code);
         ...
         Assert.Equal(StringErrorMessages.MoreCharactersThanExpectedError, validator2.Messages.First().Code);
      }
      ...
      public void MinLength_and_MinLengthIf_WithDefaultMessage()
      {
         ...
         validator1.Validate(person1);
         Assert.Single(validator1.Messages);
         Assert.Equal(StringErrorMessages.FewerCharactersThanExpectedError, validator1.Messages.First().Code);
      ...
      public void IsValidDate_WithDefaultMessage()
      {
         ...
         Assert.Single(validator.Messages);
         Assert.Equal(StringErrorMessages.InvalidDateError, validator.Messages.First().Code);
      }
      ...
      public void IsValidEmail_WithDefaultMessage()
      {
         ...
         Assert.Single(validator.Messages);
         Assert.Equal(StringErrorMessages.InvalidEmailError, validator.Messages.First().Code);
      }
